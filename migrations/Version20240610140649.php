 ...
 */
final class Version20240610140649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE default_adress_id_id default_adress_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE default_adress_id_id default_adress_id_id INT NOT NULL');
    }
}
